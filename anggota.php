...
<div class="container">
    ...
    <h2><center class="animated infinite rubberBand slow">Form Anggota | Perpustakaan 5G</center></h2>
      <a href="input_anggota.php" class="btn btn-primary">Input anggota</a>
                            ...
                            <td><?php echo $data['alamat'];?></td>
                             <td><?php echo $data['ttl_anggota'];?></td>
                              <td class="center"><?php echo $data['status_anggota'];?></td>
                                                ...
                                                <td class="center"><a class="btn btn-success" href="edit_anggota.php?id=<?php echo $data['id_anggota']; ?>" > Edit </a>|<a class="btn btn-danger" href="hapus_anggota.php?id=<?php echo $data['id_anggota']; ?>" 
    ...
    <tr>
    <h2><center>Perpustakaan 5G</center></h2>
    </tr>
    </table>
    </div>
</body>
