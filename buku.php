...
<h2><center class="animated infinite pulse slow">Form Buku | Perpustakaan 5G</center></h2>
  <a class="btn btn-primary" href="input_buku.php">Input buku</a>
                        ...
                        <td><?php echo $data['pengarang'];?></td>
                         <td><?php echo $data['jenis_buku'];?></td>
                          <td class="center"><?php echo $data['penerbit'];?></td>
                                            ...
                                            <td class="center "><a class="btn btn-success" href="edit_buku.php?id=<?php echo $data['kd_buku']; ?>" > Edit </a>|<a class="btn btn-danger" href="hapus_buku.php?id=<?php echo $data['kd_buku']; ?>" 
