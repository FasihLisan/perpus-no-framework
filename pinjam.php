...
<h2><center class="animated infinite pulse slow">Form Pinjam Buku | Perpustakaan 5G</center></h2>
  <a href="pinjam_buku.php" class="btn btn-primary"><i class="icon-flag"></i>  Pinjam</a>
                        ...
                        <td><?php echo $data['tgl_kembali'];?></td>
                         <td><?php echo $data['nm_anggota'];?></td>
                          <td class="center"><?php echo $data['judul_buku'];?></td>
                                            ...
                                            <td class="center"><a href="edit_pinjam.php?id=<?php echo $data['id_pinjam']; ?>" class="btn btn-success"> Edit </a> | <a href="kembali_buku.php?id=<?php echo $data['id_pinjam']; ?>" onClick = "return confirm('Apakah Anda ingin mengembalikan  <?php echo $data['judul_buku']; ?>?')" class="btn btn-danger"> Kembalikan </a></td>
                                        </tr>
...
?>      
  ...
  onClick = "return confirm('Apakah Anda ingin mengapus  <?php echo $no; ?>?')" class="btn btn-danger"> hapus</a> </td>
                                        </tr>
